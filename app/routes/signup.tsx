      ...
      <div className="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            ...
            >
              Find a mentor who gives a hoot!
            </Link>
          </p>
        </div>
              ...
              <Field
                ...
                inputRightElement={
                  <button
                    type="button"
                    onClick={() =>
                      setShowPassword((orevShowPassword) => !orevShowPassword)
                    }
                  >
                    {showPassword ? (
                      <EyeIcon className="h-4 w-4 dark:text-gray-200 text-gray-700" />
                    ) : (
                      <EyeSlashIcon className="h-4 w-4 dark:text-gray-200 text-gray-700" />
                    )}
                  </button>
                }
              />
